...
<body>
    <div style="float: left; box-sizing: border-box; width: 50%; padding: 15px;">
        <form id="MyForm">
            ...
            <input type="radio"  id="bags" name="category">bags<br>
            <input  type="radio" id="shoes" name="category">shoes<br>
            <input  type="radio" id="pants" name="category">pants<br>
            <input  type="radio" id="dress" name="category">dress<br>
            <input  type="radio" id="T-shirts"name="category">T-shirts<br>


            <select name="brand" id="brand">
            <option  value="volvo">chanel</option>
            <option value="saab">gucci</option>
            <option value="mercedes">lv</option>
            <option value="audi">bech</option>
            <option value="audi">adidas</option>
             <option value="audi">levis</option>
</select>
